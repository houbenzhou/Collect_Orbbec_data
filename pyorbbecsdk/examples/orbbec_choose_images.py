...
def process_frames(color_frame, depth_frame, align_filter, temporal_filter):
    ...
    try:
        ...
        depth_data_mm = np.where((depth_data_mm > MIN_DEPTH * 1000) & (depth_data_mm < MAX_DEPTH * 1000), depth_data_mm, 0)
        ...
        while True:
            try:
                ...
                # 保存数据
                    ...
                    if color_K is not None:
                        color_intrinsics_filename = os.path.join(output_dir, f"{frame_name}_color_intrinsics.npy")
